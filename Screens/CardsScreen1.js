...
import {
 ...
 export default class CardsScreen1 extends React.Component{
  constructor(props){
    super(props);
    this.state={
    dataSource: [],
    ...
    onlyoutbounddate: this.props.navigation.state.params.onlyoutbounddate,
  ...
  closeDrawer() {
    ...
    componentDidMount(){
      fetch('http://192.168.1.208/BEUDAN/MyProject/PHP/oneway.php', {
        method: 'POST',
        headers: {
        ...
        body: JSON.stringify({
          ...
          onlyoutbounddate: this.state.onlyoutbounddate,
        })
        ...
        <View style={styles.mainContainer}>
         ...
         <FlatList
          padding ={15}
            ...
            {item.flight[0].OriginStation} to {item.flight[0].DestinationStation}
            </Text>
            
            <Text style={{fontSize: 15, paddingVertical: 2}} >{item.flight[0].DepartureDate}  to  {item.flight[0].ArrivalDate}</Text>
            <Text style={{fontSize: 15, paddingVertical: 2}}>{item.flight[0].DepartureTime} to {item.flight[0].ArrivalTime}</Text>
            <Text style={{fontSize: 25, paddingVertical: 2,fontFamily:'bold',color:'blue'}}>{item.flight[0].FlightName}</Text>
            ...
            <Text style={{fontSize: 15, paddingVertical: 2}}>{item.flight[0].Stops}</Text>
            ...
            <TouchableOpacity style={styles.buttonContainer}
             onPress={() =>  
              this.props.navigation.navigate('Pay1',{
              oStation: item.flight[0].OriginStation,
          dStation: item.flight[0].DestinationStation,
          dDate: item.flight[0].DepartureDate,
          aDate: item.flight[0].ArrivalDate,
          dTime: item.flight[0].DepartureTime,
          aTime: item.flight[0].ArrivalTime,
          fName: item.flight[0].FlightName,
          fNumber: item.flight[0].FlightNumber,
          fDuration: item.flight[0].Duration,
          fPrice: item.price,
          adults:this.state.adults,
          children:this.state.children,
          infants:this.state.infants,
