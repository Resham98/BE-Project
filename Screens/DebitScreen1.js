...
export default class DebitScreen1 extends React.Component{
  constructor(props) {
    super(props);
...
Booking = () =>{
  ...
  fetch('http://192.168.1.208/BEUDAN/MyProject/PHP/booking.php', {
    method: 'POST',
    headers: {
       ...
       return(
        ...
        <View style={styles.containerP}>
          ...
          <TouchableOpacity style={styles.buttonContainer}>
           <Text style={styles.buttonText} onPress={this.Booking}>PROCEED TO PAY</Text>
          </TouchableOpacity>
